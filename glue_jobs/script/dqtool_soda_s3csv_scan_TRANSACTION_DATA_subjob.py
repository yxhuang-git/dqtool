...
# 获取传递的参数
start_line = int(sys.argv[1])  # 从命令行获取start_line
end_line = int(sys.argv[2])    # 从命令行获取end_line
input_file = sys.argv[3]       # 获取CSV文件的S3路径

# 处理CSV的指定行范围
def process_csv_part(start, end, file_path):
...
# S3からファイルをダウンロードする
s3_bucket = 'dqtool'
file_name = "TRANSACTION_DATA_性能_500万件"
